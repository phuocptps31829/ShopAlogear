...
import { productNoPriceSchema } from "../../../../zods/admin/product";
...
export default function ProductHasPrice({ data: dataProduct }) {
  ...
  const {
    ...
    resolver: zodResolver(productNoPriceSchema),
    defaultValues: {
      name: "",
      description: "",
      detail: "",
